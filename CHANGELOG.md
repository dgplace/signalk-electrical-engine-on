...
### Fixed
- Schema `enum` arrays for `polarity` and `dc_polarity` are distinct copies so SignalK Plugin CI JSON-walk validation no longer reports a false circular reference
